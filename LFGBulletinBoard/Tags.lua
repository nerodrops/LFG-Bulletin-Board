...
GBB.dungeonTagsLoc={
	...
	deDE =langSplit({
		...
		["STR"] = 	"lebend untot",
		["SCH"] = 	"scholomance scholo sholo sholomance",
		["LBRS"] = 	"untere spitze schwarzfels lower lbrs lrbs",
		["UBRS"] =	"obere spitze schwarzfels upper ubrs urbs rend",
                ["RAMPS"] = 	"bollwerk bw",
		["BF"] = 	"blutkessel bk",
		["SP"] = 	"sklaven sklavenunterkuenfte sk",
		["UB"] = 	"tiefensumpf ts",
		["MT"] = 	"managruft mg gruft",
		["CRYPTS"] = 	"krypt krypta auchenai",
		["SETH"] = 	"sethekk sh sethekhallen hallen sethekkhallen",
		["OHB"] = 	"hdz1 hdz 1 hoehlen der zeit Hillbrad",
		["MECH"] = 	"mech mechanar",
		["BM"] = 	"schwarz schwarzer morast",
		["MGT"] = 	"magie terasse magister",
		["SH"] = 	"zerschmettert zerschmetterte hallen zh",
		["BOT"] = 	"botanika botanica bot",
		["SL"] = 	"schatten laby schlabby sl ",
		["SV"] = 	"dampfkammer dk dampf kammer",
		["ARC"] = 	"arka arkatraz alkatraz",
		["KARA"] = 	"kara kz karazhan",
		["GL"] = 	"gl gruul gruuls gruul's",
		["MAG"] = 	"mag magtheridon magtheridon's magth",
		["SSC"] = 	"ssc serpentshrine serpentshine",
		...
		["SWP"] = 	"swp sunwell plateau plataeu sunwel",
		["ONY"] = 	"onyxia",
		["MC"]  = 	"geschmolzen geschmolzener kern",
		["ZG"]  = 	"zul gurub",
		--["AQ20"] = 	{},
		--["BWL"] = 	{},
		--["AQ40"] = 	{} ,
	...
	ruRU = langSplit({
		...
		["RAMPS"] = "бастион бастионы бап",
		["BF"] = "кузня крови кк кузню",
		["SP"] = "узилище",
		["UB"] = "нижетопь нт нежитопь",
		["MT"] = "гробницы маны гм грабницу манатомбс манатомбы",
		["CRYPTS"] = "аукенайские гробницы аг",
		["SETH"] = "сетеккские залы сз",
		["OHB"] = "Пещеры Времени Старые предгорья Хилсбрада спх пв",
		["MECH"] = "Крепость Бурь Механар кбм",
		["BM"] = "Пещеры Времени Черные топи",
		["MGT"] = "Терраса магистров тм",
		["SH"] = "Цитадель Адского Пламени: Разрушенные залы рз",
		["BOT"] = "Крепость Бурь Ботаника кбб",
		["SL"] = "Аукиндон Темный Тёмный  лаберинт лабиринт шл",
		["SV"] = "Резервуар Кривого Клыка Паровое подземелье",
		["ARC"] = "Крепость Бурь Аркатрац кба",	
